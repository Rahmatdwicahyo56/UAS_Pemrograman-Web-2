		...
		<form method="post" action="../fungsi/edit" enctype="multipart/form-data">
			<table style="background: transparent;">
				...
				<tr>
					<td>Jenis Kelamin</td>
					<td>
					<select name="jkel" required="required" style="font-weight: bold">
					<?php $opsi = ['Laki-Laki','Perempuan'];?>
						<option hidden="hidden">-Pilih Gender-</option>
						<?php foreach($opsi as $gendr): ?>
						<option value="<?php echo $gendr;?>" <?php echo ($jkel == $gendr) ? 'selected' : '';?>>
						<?php echo $gendr;?></option>
						<?php endforeach;?>
					</select>
				</td>
				</tr>
