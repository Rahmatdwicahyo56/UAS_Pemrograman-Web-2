...
<html>
<head>
	<title>Sistem Informasi Pemesanan Kamar Pada Hotel Araya</title>
	<meta charset="utf-8">
...
<body>
	<nav>
			<!--<img src="../gambar/horisonkdi.png" width="200px">--><span style="color:white;font-size:50px;">Araya Hotels</span> <span style="float: right; margin-right: 80px;"><center><img src="../simpangambar/<?php 
				if ($foto != '') {
					echo $foto;
				}
				else {
