	...
	<div id="imgindex">
		<div id="imglog">
			...
			<div id="tentang">
				...
				<p>
				Hotel Araya Ini adalah cabang dari Aozora Group yang terletak di pusat kota. Hotel ini merupakan hotel bintang tiga yang berlokasi strategis di pusat kota . Lokasi yang sempurna dan akses mudah ke daerah wisata membuat Horison Hotel tempat yang bagus untuk pengunjung bisnis dan liburan. Hotel ini memiliki total 58 kamar yang terdiri atas 7 Kamar Superior, 45 Kamar Deluxe, 4 Suite Junior, dan 2 Suite Eksekutif.
				</p><br>
				<p>
				Hotel ini berjarak sekitar 10 km dari Bandara Nasional. Bangunan Landmark Kota bisa ditempuh dengan berkendara kurang dari lima menit, sementara pusat perbelanjaan dapat diakses dengan delapan menit berkendara dari penginapan.
				</p>
			</div>
			...
			<div id="cekinout">
				...
				<h4>Check-In</h4>
				<p>Jam Check-In Standar : 17.00 WIB</p>
