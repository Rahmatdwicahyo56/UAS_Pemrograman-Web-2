...
<html>
<head>
	<title><?=ucfirst($_SESSION['type']);?> | Dashboard</title>
	<link rel="stylesheet" href="css/style.css" type="text/css"/>
</head>
<body>
	<header>
		<h1 class="judul">Hotel Araya</h1>
	...
	<main>
		<ul>
			<li><a href="beranda" class="kiri">Beranda <?=ucfirst($_SESSION['type']);?></a></li>
			<?php if($_SESSION['type'] == 'admin' or $_SESSION['type'] == 'pimpinan'):?>
			...
			<?php endif;?>
			<?php if($_SESSION['type'] == 'staff' or $_SESSION['type'] == 'pimpinan'):?>
